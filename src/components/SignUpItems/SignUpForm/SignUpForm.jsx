  ...
  const texFiled = [
    {
      ...
      onchange: () => console.log("okay1"),
    },
    {
      id: 2,
      label: "نام خانوادگی:",
      place: "نام خانوادگی خود را وارد کنید...",
      onchange: () => console.log("okay2"),
    },
    {
      id: 3,
      label: "کد ملی:",
      place: "کد ملی خود را وارد کنید...",
      onchange: () => console.log("okay3"),
    },
    {
      id: 4,
      label: "محل سکونت:",
      place: "محل سکونت خود را وارد کنید...",
      onchange: () => console.log("okay4"),
    },
    {
      id: 5,
      label: "کد پستی:",
      place: "کدپستی خود را وارد کنید...",
      onchange: () => console.log("okay4"),
    },
  ];
  return (
