...
<Typography className="animate__animated animate__backInRight" sx={{color:'#fff',fontWeight:"bold",textAlign:"center",fontSize:{xs:"28px",md:"35px"}}} variant='h4'>{props.item.text}</Typography>
<Typography className='animate__animated animate__backInLeft' sx={{color:"#fff",fontWeight:"bold",textAlign:"center",fontSize:{xs:"28px",md:"45px"}}} variant='h2'>{props.item.title}</Typography>
