        ...
        <>
            <Grid container xs={12} >
                ...
                <Grid item xs={8} sx={{margin:"10px auto"}}>
                    <Typography sx={{width:"55%" , fontSize:"18px"  ,color:"#6a6a6a"}}>
                    ...
                    <Typography sx={{width:"55%" , mt: 2 , fontSize:"18px" , color:"#6a6a6a"}}>
                    ...
                    <Button variant="contained" color="warning" sx={{position:"absolute",left:"50%",mt: 4,transition:".5s",borderRadius:"0" , p: "15px 35px" , color:"#000" , fontSize:"16px"}}>ادامه دیگر</Button>
                </Grid>
